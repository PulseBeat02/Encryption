package java.pulsebeat02.encryptionMethods.RSA_Security.RC6;

import java.pulsebeat02.encryptionMethods.RSA_Security.RSAMethods;

public class RC6 extends RSAMethods {
...
//	private static final double goldenRatio = 1.6180339887496482;
	...
	public static int rotl(int val, int pas) {
		
		return (val << pas) | (val >>> (32 - pas));
	}
	
	public static int rotr(int val, int pas) {
